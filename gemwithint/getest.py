...
chat.send_message(f"todays date is {date.today()} and my loaction is {location.address} ,Suppose you are a ai assistant for a farmer , your work is to answer queries related to farming and all" , safety_settings={'HARASSMENT':'block_none'})
chat.send_message(f"you are also a helpful assistant that helps the farmer in a lot of things ")
